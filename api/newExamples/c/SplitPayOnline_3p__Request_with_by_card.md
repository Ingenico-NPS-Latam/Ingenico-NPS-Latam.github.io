...
int main(int argc, char **argv) {
    ...
    pRequest->psp_UseMultipleProducts = malloc(strlen('1')+1);
    strcpy(pRequest->psp_UseMultipleProducts, '1');
    ...
    ptr->psp_MerchTxRef = malloc(strlen('ORDER76666-3')+1);
    strcpy(ptr->psp_MerchTxRef, 'ORDER76666-3');
    ...
    ptr->psp_MerchTxRef = malloc(strlen('ORDER76666-4')+1);
    strcpy(ptr->psp_MerchTxRef, 'ORDER76666-4');
