...
int main(int argc, char **argv) {
    ...
    pCustomerAdditionalDetails->DeviceFingerPrint = malloc(strlen('YOUR_DEVICE_FINGER_PRINT')+1);
    strcpy(pCustomerAdditionalDetails->DeviceFingerPrint, 'YOUR_DEVICE_FINGER_PRINT');
